 ...
 *                 message:
 *                   type: string
 *                   example: Password must be at least 8 characters long and not includes $
 *       403:
 ...
 *       403:
 *         description: New Password does not meet the requirements
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: New Password must be at least 8 characters long and not includes $
 *       404:
 *         description: User not found
 *         content:
 *           application/json:
